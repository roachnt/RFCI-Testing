...
source('RforCFmeansRF_steins_algorithm.R')
# 3
...
steins_algorithm <- na.omit(data.frame(Y, newoutput))
print(length(steins_algorithm$a_0))

CFmeanResult <- genCFmeansRF_steins_algorithm(steins_algorithm)
