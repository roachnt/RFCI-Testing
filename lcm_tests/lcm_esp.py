...
input_data_unformatted = pd.read_csv(
    "programinputs.txt", header=None, delim_whitespace=True).transpose()
...
for i, pred_name in enumerate(predicate_dict.keys()):
    if i == 100:
        break
...
print(len(pred_importance_list))
